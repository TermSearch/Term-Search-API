var domainCodes = require('../lib/SubjectFields.json');
...
module.exports.toNrArr = toNrArr;
...
// Converts "Organisation of elections,Voting method" to [416005, 416008]
function toNrArr(str) {
  var strArr = str.split(',');
	var nrArr = [];
	strArr.forEach(function(str) {
    nrArr.push(toNr(str));
	});
	return nrArr; // returns an array of numbers
}
